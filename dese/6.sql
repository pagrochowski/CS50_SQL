...
--SELECT * FROM graduation_rates WHERE school_id IN (SELECT school_id FROM graduation_rates WHERE graduated / (graduated + dropped + excluded) = 1 AND (graduated + dropped + excluded) != 0);