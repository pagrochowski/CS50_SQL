--First, lets frame Emily33
UPDATE users SET password = '44bf025d27eea66336e5c1133c3827f7' WHERE username = 'admin';

--Second, we change the password to oops:
UPDATE users SET password = '982c0381c279d139fd221fce974916e7' WHERE username = 'admin';

--Third, we remove the latest log
DELETE FROM user_logs WHERE old_password = '44bf025d27eea66336e5c1133c3827f7';
