...
--a current player for Cal Ripken Jr., a star player who’s likely nearing his retirement. 
...
--SELECT * FROM "players" WHERE first_name LIKE "%Ripken%" OR last_name LIKE "%Ripken%";